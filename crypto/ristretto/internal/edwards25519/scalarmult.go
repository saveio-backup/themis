...
func (v *ProjP3) MultiscalarMul_hmy(scalars []*scalar.Scalar, elements []*ProjP3) *ProjP3 {
	v.Zero()
...
func (v *ProjP3) VartimeMultiscalarMul_hmy(scalars []*scalar.Scalar, points []*ProjP3) *ProjP3 {
	if len(scalars) != len(points) {
		panic("called MultiscalarMul with different size inputs")
	}
	v.Zero()
